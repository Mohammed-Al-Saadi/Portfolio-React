...
export const projects = [
  ...
  },
  {
    ...
    content:
      "This full-stack web application, developed with Flask, React, and PostgreSQL...",
    fullText:
  ...
  },
  {
    ...
    content:
      "Buba Salon: The static website for Buba Salon was created using React JS...",
    fullText:
      "The static website for Buba Salon was created using React JS, providing a seamless user experience. It features essential information such as contact details, location, and a comprehensive list of services. With a clean, modern design, the site ensures easy navigation, allowing visitors to quickly find the details they need.",
  },
  {
    videoUrl: Omar,
    ...
    content:
      "The static website for Omar Parturi was created using React JS...",
    fullText:
